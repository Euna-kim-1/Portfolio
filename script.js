...
document.getElementById('playButton4').addEventListener('click', function () {
    ...
    newWindow.document.body.innerHTML = '<video width="100%" height="100%" controls autoplay><source src="videos/us_state_game.mp4" type="video/mp4">Your browser does not support the video tag.</video>';
});
...
document.getElementById('playButton5').addEventListener('click', function () {
    ...
    newWindow.document.body.innerHTML = '<video width="100%" height="100%" controls autoplay><source src="videos/password_manager.mp4" type="video/mp4">Your browser does not support the video tag.</video>';
});